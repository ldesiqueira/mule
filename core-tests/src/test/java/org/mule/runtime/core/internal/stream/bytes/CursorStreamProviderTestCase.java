...
public class CursorStreamProviderTestCase extends AbstractByteStreamingTestCase {
  ...
  public CursorStreamProviderTestCase(String name, int dataSize, int bufferSize) {
    ...
    if (dataSize <= bufferSize) {
      streamProvider = new ByteArrayCursorStreamProvider(new ByteArrayInputStream(data.getBytes()), bufferSize);
    } else {
      streamProvider = new BufferedCursorStreamProvider(new ByteArrayInputStream(data.getBytes()), bufferSize);
    }
    resetLatches();
  }
