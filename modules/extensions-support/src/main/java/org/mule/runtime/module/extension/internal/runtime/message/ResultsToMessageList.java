...
public final class ResultsToMessageList extends ResultsToMessageCollection implements List<Message> {
  ...
  public ResultsToMessageList(List<Result> delegate, MediaType mediaType, CursorStreamProviderFactory cursorStreamProviderFactory) {
  ...
  public void sort(Comparator<? super Message> c) {
    delegate.sort((o1, o2) -> c.compare(toMessage(o1, mediaType, cursorStreamProviderFactory), toMessage(o2, mediaType, cursorStreamProviderFactory)));
  }
